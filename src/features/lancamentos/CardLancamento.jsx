    ...
    return (
        <AnimatePresence mode="wait">
            <motion.div
                ...
                className="flex flex-col h-auto p-3 backdrop-blur-md transform bg-neutral-800 border border-white/10 rounded-[14px] w-full max-w-[420px] shadow-[0_0_30px_rgba(0,0,0,0.1)]"
            >
