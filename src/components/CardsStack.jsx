...
export default function CardsStack() {
  ...
  <div className="relative w-full max-w-[350px] md:max-w-[400px] min-h-[250px] p-22 md:p-4">

      <h1 className="text-gray-200 text-2xl font-normal mb-2 ml-1">Fila Inteligente</h1>
  ...
  return (
    ...
    <div
      ...
      className={`
        ...
        ${isTop ? "p-1.5 h-auto" : "p-3 h-[60px] opacity-40"} 
      `}
