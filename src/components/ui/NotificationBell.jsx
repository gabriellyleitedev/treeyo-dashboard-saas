  ...
  return (
    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        ...
        <div className="fixed right-4 top-16 w-[92vw] max-w-[360px] max-h-[420px] flex flex-col overflow-hidden bg-[#141414]/95 backdrop-blur-md border border-white/10 rounded-xl shadow-2xl z-[9999]">
